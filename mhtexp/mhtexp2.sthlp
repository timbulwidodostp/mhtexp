...
{phang}
{bf:mhtexp2} {hline 2} Stata command for the procedure detailed in List, Shaikh, and Vayalinkal (2023)
...
{phang}
By default {cmd:mhtexp2} will calculate all hypothesis based on the number of outcomes, subgroups and treatments provided by the user
in {it:varlist} {it:group(varname)} and {it:treatment(varname)}, respectively. In section 4.4 of List, Shaikh, and Vayalinkal (2023) simultaniously consider
